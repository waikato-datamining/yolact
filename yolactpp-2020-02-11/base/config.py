...
# import external config/dataset from file referenced in YOLACTPP_CONFIG env var
# taken from here:
# https://stackoverflow.com/questions/57060982/
import os
import importlib.util
if os.getenv('YOLACTPP_CONFIG') is not None:
    if os.path.exists(os.getenv('YOLACTPP_CONFIG')):
        spec = importlib.util.spec_from_file_location('external_config', os.environ['YOLACTPP_CONFIG'])
